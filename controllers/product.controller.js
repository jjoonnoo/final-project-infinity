...
class ProductController {
    ...
    auctionProductFind = async (req, res) => {
        try {
            ...
            const data = await this.productService.auctionProductFind(auction_product_id)
    ...
    auctionProductPurchase = async (req, res) => {
        ...
        try {
            const { auction_product_id } = req.params
            const data = await this.productService.auctionProductPurchase(auction_product_id, user_id)
